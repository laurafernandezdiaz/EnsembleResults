...
from .grid_search_automl import grid_search_automl as grid_search_automl
from .mean_automl_run import mean_automl_run 
from sklearn.model_selection import KFold
import statistics
class my_grid_combine:
    
    def __init__(self,MLS,GSparams,RG,scoring,cv_split,exp,rep,X,y,wrapper='RBST_ICM'):
        ...
        for i in range(0,rep):
            ...
            for train_index, test_index in kf.split(X):
                ...
                #GRID combine
                self.grid_combine=grid_search_automl(MLS,GSparams,cv,scoring,i,cv_split,exp,wrapper,fold)
                ...
                print('Coefs '+str(fold)+':',self.grid_combine.Mywrapper.coef_)
                print('Number of used models '+str(fold)+': '+str(self.grid_combine.Mywrapper.used)+ '/'+str(len(self.grid_combine.Mywrapper.coef_)))
