...
class data_table:
    ...
    def __init__(self,MLS,X,y,GSparams,RG,scoring,total_params,rep,cv_split=2,exp=1):
        ...
        Params:
            ...
            Integer parameters:
            - total_params : Number of total params
        ...
        self.rep=rep
        #Creating the fields
        self.coef_grid_=[] #Attribute to save the coef of the estimator fitted.       
    ...
    def fit(self):
        ...
        #n_rep = int(self.rep) #Number of repetitions
        ...
        self.evals_pred=self.data_unique[:,n_X+2:-1]#y_pred#self.data[:,n_X:-1]
