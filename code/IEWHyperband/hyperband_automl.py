...
class hyperband_automl:
    ...
    def fit(self,X,y):
        ...
        self.inversos=np.empty((points), dtype=object)   
    ...
    def predict(self,X):
        ...
        self.preds_params=np.array(self.preds_params).T
        
        self.preds_params_pond=np.empty((self.X_test.shape[0], self.preds_params.shape[1]), dtype=object)
