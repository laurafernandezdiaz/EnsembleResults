    ...
    def __init__(self,MLS,GSparams,RG,scoring,cv_split,exp,rep,X,y,wrapper='RBST_ICM'):
        ...
        for i in range(0,rep):
            ...
            for train_index, test_index in kf.split(X):
                ...
                #random combine
                self.random_combine=random_search_automl(MLS,GSparams,cv,scoring,i,cv_split,exp,wrapper,fold)
                ...
                print('Coefs '+str(fold)+':',self.random_combine.Mywrapper.coef_)
                print('Number of used models '+str(fold)+': '+str(self.random_combine.Mywrapper.used) + '/'+str(len(self.random_combine.Mywrapper.coef_)))
                 #GRID mean
