...
from BEMGS.my_grid_combine import my_grid_combine
...
with open(str(path)+'\\'+str(exp)+'\\grid_regression_mean_'+str(dataname)+'_'+str(MLSName)+'_'+str(scoringName)+'_'+str(cv)+'_'+str(exp), 'wb') as file:
