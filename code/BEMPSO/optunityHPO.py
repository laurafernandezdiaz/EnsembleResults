...
def PSOOptCGammaKernelParam(base,Cbounds,Kernelbounds,Gammabounds,X,Y,num_evals,loss,loss_sign,cv,cv_state,rep=1,fold=1):
    ...
    if loss_sign==-1:
        #pars, details, _ = optunity.minimize_structured(SysWrap, search_space=space, num_evals=num_evals)
        ...
        #pars, details, _ = optunity.maximize_structured(SysWrap, search_space=space, num_evals=num_evals)
