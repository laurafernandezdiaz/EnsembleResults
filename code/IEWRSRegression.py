...
from IEWRS.my_random_combine import my_random_combine
...
with open(str(path)+'\\'+str(exp)+'\\random_regression_generalized_'+str(dataname)+'_'+str(MLSName)+'_'+str(scoringName)+'_'+str(cv)+'_'+str(exp), 'wb') as file:
