...
from Hyperband.my_hyperband_combine import my_hyperband_combine
...
with open(str(path)+'\\'+str(exp)+'\\grid_regression_hyperband_'+str(dataname)+'_'+str(MLSName)+'_'+str(scoringName)+'_'+str(cv)+'_'+str(exp), 'wb') as file:
