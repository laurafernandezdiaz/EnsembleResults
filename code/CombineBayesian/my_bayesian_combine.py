...
class my_bayesian_combine:
    ...
    def __init__(self,MLS,GSparams,RG,scoring,cv_split,exp,rep,X,y,wrapper='Mean'):
        ...
        for i in range(0,rep):
            ...
            for train_index, test_index in kf.split(X):
                ...
                self.grid_combine=bayesian_automl(MLS,GSparams,scoring,cv_split,i,fold,exp,wrapper)
